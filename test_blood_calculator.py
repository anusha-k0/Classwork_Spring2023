...
@pytest.mark.parametrize("HDL_input, expected", test_HDL)
# Decorates a function and gives it additional functionality
# ^Decorator
...
test_LDL = [(100, "Normal"), (140, "Borderline High"),
            (175, "High"), (200, "Very High")]


@pytest.mark.parametrize("LDL_input, expected", test_LDL)
# Decorates a function and gives it additional functionality
# ^Decorator
